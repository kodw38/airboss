...
public class UserBean {
    ...
    public void setDummyTag(String dummyTag) {
        this.dummyTag = dummyTag == null ? null : dummyTag.trim();
    }
    ...
    public void setServiceStateCode(String serviceStateCode) {
        this.serviceStateCode = serviceStateCode == null ? null : serviceStateCode.trim();
    }
    ...
    public Date getPreDestroyDate() {
        return preDestroyDate;
    }

    public void setPreDestroyDate(Date preDestroyDate) {
        this.preDestroyDate = preDestroyDate;
    }
    ...
    public Long getBaseCreditValue() {
        return baseCreditValue;
    }

    public void setBaseCreditValue(Long baseCreditValue) {
        this.baseCreditValue = baseCreditValue;
    }
