...
{
    @Autowired
    private ScheduleTaskLogMapper jobLogMapper;
     ...
     */
    @Override
    public ScheduleTaskLog selectJobLogById(Long jobLogId,Date createTime)
    {
        return jobLogMapper.selectJobLogById(jobLogId,createTime);
    }
