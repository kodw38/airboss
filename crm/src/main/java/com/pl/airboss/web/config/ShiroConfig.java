package com.pl.airboss.web.config;

import at.pollux.thymeleaf.shiro.dialect.ShiroDialect;
import com.pl.airboss.utils.SpringUtils;
import com.pl.airboss.utils.StringUtils;
import com.pl.airboss.web.filter.*;
import com.pl.airboss.web.filter.*;
import com.pl.airboss.web.utils.OnlineSessionFactory;
import com.pl.airboss.web.service.UserRealm;
import com.pl.airboss.web.dao.OnlineSessionDAO;
import com.pl.airboss.web.service.OnlineWebSessionManager;
import com.pl.airboss.web.utils.MyRedisCacheManager;
import com.pl.airboss.web.utils.SpringSessionValidationScheduler;
...
{
    @Value("${shiro.isUsedRedis}")
    public boolean isUsedRedis; //是否使用redis来集中存储登录信息
    ...
    public ShiroFilterFactoryBean shiroFilterFactoryBean(SecurityManager securityManager)
    {
        ...
        filterChainDefinitionMap.put("/title.png**", "anon");
        ...
        //获取主键监控信息，供给管理服务调用
        filterChainDefinitionMap.put("/monitor/server/detail", "anon");
        // 系统权限列表
