...
import com.pl.airboss.web.bean.*;
import com.pl.airboss.web.dao.SecFunctionBeanMapper;
...
public class UserRealm extends AuthorizingRealm
{
    ...
    @Autowired
    private SecFunctionBeanMapper menuService;

    @Autowired
    private SecRoleOPBeanMapper roleService;
    ...
    protected AuthorizationInfo doGetAuthorizationInfo(PrincipalCollection arg0)
    {
        ...
        {
            roles = new HashSet(roleService.selectRoleCodesByOpId(user.getRecId()));
            menus = new HashSet(menuService.selectMenuPermsByOpId(user.getRecId()));
